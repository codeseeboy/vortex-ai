          ...
          <div className="glass-dark rounded-2xl p-8 md:p-12" style={{ borderColor: "rgba(236, 72, 153, 0.3)" }}>
            ...
            <div className="bg-pink-950/30 rounded-xl p-6 border border-pink-900/40 mb-10">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-pink-400 font-bold mb-2">Day 18: Qualifiers Round</h4>
                  <ul className="space-y-2 text-gray-300 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="text-pink-400 mt-0.5">▸</span>
                      <span>Total teams will be divided into two Groups (A & B).</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-pink-400 mt-0.5">▸</span>
                      <span>Each team in both groups will play 2 matches.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-pink-400 mt-0.5">▸</span>
                      <span>Advancement: Half of the total participating teams will be selected for the Finals on Day 19.</span>
                    </li>
                  </ul>
                </div>
              </div>
